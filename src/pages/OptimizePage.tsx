  ...
  return (
    <div className="flex flex-col gap-6 max-w-5xl mx-auto">
      ...
      <div data-tour="optimize-card" className="bg-white rounded-xl border border-slate-200 p-5">
        ...
        {!hasRules ? (
          <div className="p-4 bg-slate-50 rounded-xl text-sm text-slate-500">Configure card rewards in Wallet to see optimization tips.</div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5">
        ...
        {credits.length === 0 ? (
          <div className="p-4 bg-slate-50 rounded-xl text-sm text-slate-500">
            Add credits in Wallet to track your statement and portal credits.
          </div>
        ) : (
