  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0e17] px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] bg-gradient-to-br from-[#141a2a] to-[#0f1422] border border-teal-500/[0.12] rounded-2xl p-9 relative z-10">
        ...
        <h1 className="text-2xl font-bold text-gray-100 mb-1.5 tracking-tight">Welcome back</h1>
      ...
      {showReset && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4 backdrop-blur-sm">
          <div className="w-full max-w-[420px] rounded-2xl border border-teal-500/[0.14] bg-[#111827] p-7 shadow-2xl">
            ...
            <form onSubmit={handleResetRequest}>
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={() => setShowReset(false)}
                  className="flex-1 py-3 border border-white/10 rounded-xl text-gray-300 text-sm font-semibold hover:bg-white/5"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-3 bg-teal-500 text-[#0a0e17] rounded-xl text-sm font-semibold
