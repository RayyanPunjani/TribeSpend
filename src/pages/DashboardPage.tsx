...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto flex flex-col gap-5">
        ...
        <div className="rounded-xl border border-accent-200 bg-accent-50 px-4 py-3">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
              <Link
                to="/app/upload"
                className="inline-flex min-h-11 items-center justify-center gap-1.5 rounded-lg bg-accent-600 px-3 py-2 text-xs font-semibold text-white hover:bg-accent-700"
              >
                <Upload size={14} /> Upload CSV
              </Link>
              <Link
                to="/app/wallet?tab=linkedAccounts"
                className="inline-flex min-h-11 items-center justify-center gap-1.5 rounded-lg bg-white px-3 py-2 text-xs font-semibold text-amber-700 shadow-sm ring-1 ring-amber-200 hover:bg-amber-50"
              >
      ...
      <div data-tour="dashboard-overview" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          label="Total Spend"
