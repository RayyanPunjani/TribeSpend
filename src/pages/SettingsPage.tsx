        ...
        <div className="flex min-w-max gap-1 rounded-xl bg-slate-100 p-1 sm:min-w-0 sm:flex-wrap">
          {TABS.map(({ id, label, icon: Icon }) => (
            <button
              ...
              className={`flex min-w-[112px] items-center justify-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium transition-all sm:flex-1 ${
                tab === id
      ...
      <div className="p-4 flex flex-col gap-3">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
          ...
          <button
            ...
            className="flex min-h-11 items-center justify-center gap-1.5 rounded-lg border border-slate-300 px-3 py-2 text-sm font-medium text-slate-600 transition-colors hover:bg-slate-50 disabled:opacity-60 sm:shrink-0"
          >
